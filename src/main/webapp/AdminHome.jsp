...
<nav role='navigation'>
  <ul class="main">
    <li class="dashboard"><a href="addCourse.jsp">Add course</a></li>
    <li class="users"><a href="addStudent.jsp">Add Student</a></li>
    <li class="users"><a href="addProfessor.jsp">Add Professor</a></li>
    <li class="comments"><a href="removeCourse.jsp">Remove Course</a></li>
    <li class="comments"><a href="removeProfessers.jsp">Remove Professor</a></li>
    <li class="comments"><a href="removeStudents.jsp">Remove Student</a></li>
    <li class="users"><a href="viewAllStudents.jsp">View All Students</a></li>
    <li class="dashboard"><a href="viewAllCourses.jsp">View All Courses</a></li>
    <li class="users"><a href="viewAllProfessors.jsp">View All Professors</a></li>
