...
<div class="login-page">
        <div class="form">
            <form class="login-form " action="Getscores" method="post" >
                <h2 align="center">Get Score</h2>
                <input type="text" required name="sid" placeholder="Student ID" id="user" autocomplete="off" />
